...
const useFetchAllProducts = () => {
    ...
    useEffect(() => {
        const fetchAllProducts = async () => {
            setLoading(true);
            try {
                const response = await axios.get("https://ecommerce-platform-backend-8gyl-2awpih086-khuzzzis-projects.vercel.app/api/v1/seller/allProducts", { withCredentials: true });
